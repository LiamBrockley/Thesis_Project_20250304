...
writeLines(c("Genes common to upregulated 24 hr cell line genes and LUAD_A1_TE: ", intersect(LUAD_A1_TE$Gene, up_24h_18694499)))
...
writeLines(c("Genes common to upregulated 24 hr cell line genes and LUSC_A1_TE: ", intersect(LUSC_A1_TE$Gene, up_24h_18694499)))
...
writeLines(c("Genes common to upregulated genes in 1 month exposure to smoke and LUAD_A1_TE: ", intersect(LUAD_A1_TE$Gene, up_21095227_S2$Gene.Symbol)))
...
writeLines(c("Genes common to downregulated genes in 1 month exposure to smoke and LUAD_A1_TE: ", intersect(LUAD_A1_TE$Gene, down_21095227_S3$Gene_Symbol)))
print(c("Genes common to downregulated genes in 1 month exposure to smoke and LUAD_A1_TE_A2: ", intersect(LUAD_A1_TE_A2$Gene, down_21095227_S3$Gene_Symbol)))
print(c("Genes common to downregulated genes in 1 month exposure to smoke and LUAD_A1_TE_A2_TM: ", intersect(LUAD_A1_TE_A2_TM$Gene, down_21095227_S3$Gene_Symbol)))
## Double checking signs
...
print(c("Genes common to upregulated genes in 1 month exposure to smoke and LUSC_A1_TE_A2: ", intersect(LUSC_A1_TE_A2$Gene, up_21095227_S2$Gene.Symbol)))
...
print(c("Genes common to downregulated genes in 1 month exposure to smoke and LUSC_A1_TE_A2: ", intersect(LUSC_A1_TE_A2$Gene, down_21095227_S3$Gene_Symbol)))
...
## Compare with LUAD
paste0("PMID 28898697 list and LUAD_A1_TE: ", length(intersect(LUAD_A1_TE$Gene, S1_28898697_15m$gene)))
writeLines(intersect(LUAD_A1_TE$Gene, S1_28898697_15m$gene))
paste0("PMID 28898697 list and LUAD_A1_TE_A2: ", length(intersect(LUAD_A1_TE_A2$Gene, S1_28898697_15m$gene)))

## Compare with LUSC
paste0("PMID 28898697 list and LUSC_A1_TE: ", length(intersect(LUSC_A1_TE$Gene, S1_28898697_15m$gene)))
writeLines(intersect(LUSC_A1_TE$Gene, S1_28898697_15m$gene))
paste0("PMID 28898697 list and LUSC_A1_TE_A2: ", length(intersect(LUSC_A1_TE_A2$Gene, S1_28898697_15m$gene)))
...
# LUAD
##LUAD_A1_TE:
writeLines(c("Genes common to module 8 from 2019 study (PMID 31015447) and LUAD_A1_TE: ", intersect(LUAD_A1_TE$Gene, module_8_genes_31015447)))
##LUAD_A1_TE_A2:
writeLines(c("Genes common to Barel 2023 serial sampling irreversible gene list and LUAD_A1_TE_A2: ", intersect(LUAD_A1_TE_A2$Gene, module_8_genes_31015447)))

# LUSC
##LUSC_A1_TE:
writeLines(c("Genes common to module 8 from 2019 study (PMID 31015447) and LUSC_A1_TE: ", intersect(LUSC_A1_TE$Gene, module_8_genes_31015447)))
##LUSC_A1_TE_A2:
...
##LUAD_A1_TE:
writeLines(c("Genes common to Barel 2023 serial sampling irreversible gene list and LUAD_A1_TE: ", intersect(LUAD_A1_TE$Gene, barel_2023_irreversible_gene_list$Gene)))
##LUAD_A1_TE_A2:
writeLines(c("Genes common to Barel 2023 serial sampling irreversible gene list and LUAD_A1_TE_A2: ", intersect(LUAD_A1_TE_A2$Gene, barel_2023_irreversible_gene_list$Gene)))

##LUSC_A1_TE:
writeLines(c("Genes common to Barel 2023 serial sampling irreversible gene list and LUSC_A1_TE: "))
...
writeLines(c("Genes common to Buro-Auriemma smoking-related hypermethylated gene list and LUSC_A1_TE: ", intersect(LUSC_A1_TE$Gene, Buro_2013_25_hypermethylated$Gene)))
## 2 hits, checking next layer
...
# 1 hit, next layer
print(c("Genes common to Buro-Auriemma 2013 smoking-related hypomethylated gene list and LUAD_A1_TE_A2:", intersect(LUAD_A1_TE_A2$Gene, Buro_2013_25_hypomethylated$Gene)))
# No hits
