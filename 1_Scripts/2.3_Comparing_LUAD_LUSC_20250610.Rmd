...
## First just checking upregulated vs downregulated genes in everything

nrow(LUAD_A1_TE[sign(LUAD_A1_TE$log2FC_A1)=="1",])
nrow(LUAD_A1_TE[sign(LUAD_A1_TE$log2FC_A1)=="-1",])
nrow(LUAD_A1_TE_A2[sign(LUAD_A1_TE_A2$log2FC_A1)=="1",])
nrow(LUAD_A1_TE_A2[sign(LUAD_A1_TE_A2$log2FC_A1)=="-1",])

nrow(LUSC_A1_TE[sign(LUSC_A1_TE$log2FC_A1)=="1",])
nrow(LUSC_A1_TE[sign(LUSC_A1_TE$log2FC_A1)=="-1",])
nrow(LUSC_A1_TE_A2[sign(LUSC_A1_TE_A2$log2FC_A1)=="1",])
nrow(LUSC_A1_TE_A2[sign(LUSC_A1_TE_A2$log2FC_A1)=="-1",])

### First just comparing all gene names
...
## Checking signs
```{r}
## Now checking whether sign is the same

#Narrowing it down to the shared genes
LUAD_LUSC_A1_TE_shared <- LUAD_A1_TE %>%
  inner_join(., LUSC_A1_TE, by = "Gene", suffix = c("_LUAD", "_LUSC"))

#Make a column to state sign status
LUAD_LUSC_A1_TE_shared$sign_LUAD <- sign(LUAD_LUSC_A1_TE_shared$log2FC_A1_LUAD)
LUAD_LUSC_A1_TE_shared$sign_LUSC <- sign(LUAD_LUSC_A1_TE_shared$log2FC_A1_LUSC)
LUAD_LUSC_A1_TE_shared$signs_match <- LUAD_LUSC_A1_TE_shared$sign_LUAD == LUAD_LUSC_A1_TE_shared$sign_LUSC
## All signs match

# Checking how many up/down-regulated in shared genes
nrow(LUAD_LUSC_A1_TE_shared[LUAD_LUSC_A1_TE_shared$sign_LUAD=="1",])
nrow(LUAD_LUSC_A1_TE_shared[LUAD_LUSC_A1_TE_shared$sign_LUAD=="-1",])

## Checking the unique genes
LUAD_A1_TE_unique <- LUAD_A1_TE[!(LUAD_A1_TE$Gene %in% LUSC_A1_TE$Gene),]
nrow(LUAD_A1_TE_unique[sign(LUAD_A1_TE_unique$log2FC_A1)=="1",])
nrow(LUAD_A1_TE_unique[sign(LUAD_A1_TE_unique$log2FC_A1)=="-1",])

LUSC_A1_TE_unique <- LUSC_A1_TE[!(LUSC_A1_TE$Gene %in% LUSC_A1_TE$Gene),]
nrow(LUSC_A1_TE_unique[sign(LUSC_A1_TE_unique$log2FC_A1)=="1",])
nrow(LUSC_A1_TE_unique[sign(LUSC_A1_TE_unique$log2FC_A1)=="-1",])

## Checking signs for the methylatgion genes
nrow(LUAD_A1_TE_A2_TM[sign(LUAD_A1_TE_A2_TM$log2FC_TM)=="1",])
nrow(LUSC_A1_TE_A2_TM[sign(LUSC_A1_TE_A2_TM$log2FC_TM)=="1",])
```
...
LUAD_A1_TE_SMD_summary_overall <- read.table("../../2_Outputs/6_Meta_analysis/LUAD_A1_TE_SMD_summary_overall_20250611.txt")
LUSC_A1_TE_SMD_summary_overall <- read.table("../../2_Outputs/6_Meta_analysis/LUSC_A1_TE_SMD_summary_overall_20250611.txt")

# Filter for FDR
LUAD_A1_TE_SMD_summary_overall_filter <- LUAD_A1_TE_SMD_summary_overall[LUAD_A1_TE_SMD_summary_overall$FDR_random<=0.05,]
LUSC_A1_TE_SMD_summary_overall_filter <- LUSC_A1_TE_SMD_summary_overall[LUSC_A1_TE_SMD_summary_overall$FDR_random<=0.05,]

SMD_meta_analysis_genes <- euler(list("LUAD-A1-TE (SMD)" = unique(LUAD_A1_TE_SMD_summary_overall_filter$gene), "LUSC-A1-TE (SMD)" = unique(LUSC_A1_TE_SMD_summary_overall_filter$gene)))
...
SMD_meta_shared <- intersect(LUAD_A1_TE_SMD_summary_overall_filter$gene, LUSC_A1_TE_SMD_summary_overall_filter$gene)
# Pathways shared: https://maayanlab.cloud/Enrichr/enrich?dataset=81c21d6319be95a21dea10e8df76ec5f

# Unique to LUAD
LUAD_SMD_meta_unique <- setdiff(LUAD_A1_TE_SMD_summary_overall_filter$gene, LUSC_A1_TE_SMD_summary_overall_filter$gene)
# PAthways for LUAD: https://maayanlab.cloud/Enrichr/enrich?dataset=052df690b890326b1ce8b8247886a780

# Unique to LUSC
LUSC_SMD_meta_unique <- setdiff(LUSC_A1_TE_SMD_summary_overall_filter$gene, LUAD_A1_TE_SMD_summary_overall_filter$gene)
...
LUAD_methylation_hm450_tumor <- read.table("../3_TCGA_data/TCGA_LUAD/data_methylation_hm450_LUAD.txt", header=TRUE, fill=TRUE)
...
LUSC_methylation_hm450_tumor <- read.table("../3_TCGA_data/TCGA_LUSC/data_methylation_hm450_LUSC.txt", header=TRUE, fill=TRUE)
